...
def display_friends_content():
    ...
    subprocess.Popen(["python3", "build/gui3.py"])
...
button_image_3 = PhotoImage(file=relative_to_assets("friends_normal.png"))
button_3 = Button(
    canvas,
...
button_image_4 = PhotoImage(file=relative_to_assets("my_library_normal.png"))
button_4 = Button(
    canvas,
...
button_image_6 = PhotoImage(file=relative_to_assets("notifications_normal.png"))
button_6 = Button(
    canvas,
...
image_1 = canvas.create_image(
    ...
    100.0,  # Adjusted Y-coordinate to place at the center vertically
    image=image_image_1
)

button_1.place(relx=0.5, rely=0.35, anchor="center")  # Adjusted Y-coordinate for button_1
button_3.place(relx=0.5, rely=0.45, anchor="center")  # Adjusted Y-coordinate for button_3
