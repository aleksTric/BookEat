...
class BookDetails:
    ...
    def get_book(self):
        ...
        canvas.create_text( 101.0, 207.0, anchor="nw", text="TITLE", fill="blue", font=("Inter Medium", 25 * -1))
        canvas.create_text( 101.0, 307.0, anchor="nw", text="AUTHOR", fill="blue", font=("Inter Medium", 25 * -1))
